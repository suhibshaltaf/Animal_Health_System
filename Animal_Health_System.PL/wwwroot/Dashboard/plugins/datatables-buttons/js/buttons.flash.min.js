...
setSheetData:function(a){this.ready&&this.movie.setSheetData(JSON.stringify(a))},setAction:function(a){this.action=a;this.ready&&this.movie.setAction(a)},addEventHashSetener:function(a,b){a=a.toString().toLowerCase().replace(/^on/,"");this.handlers[a]||(this.handlers[a]=[]);this.handlers[a].push(b)},setHandCursor:function(a){this.handCursorEnabled=a;this.ready&&this.movie.setHandCursor(a)},setCSSEffects:function(a){this.cssEffects=!!a},receiveEvent:function(a,b){a=a.toString().toLowerCase().replace(/^on/,
...
D;p++)v.push(m(a.body[p]));return{str:C+v.join(c)+b,rows:v.length}},H={available:function(){return l.hasFlash()},init:function(a,b,c){l.moviePath=z.Buttons.swfPath;var d=new l.Client;d.setHandCursor(!0);d.addEventHashSetener("mouseDown",function(g){c._fromFlash=!0;a.button(b[0]).trigger();c._fromFlash=!1});L(d,b);c._flash=d},destroy:function(a,b,c){c._flash.destroy()},fieldSeparator:",",fieldBoundary:'"',exportOptions:{},title:"*",filename:"*",extension:".csv",header:!0,footer:!1},I="";I="undefined"===
